    ...
    public unsafe class Injector : EasyHook.IEntryPoint
    {
        ...
        unsafe static int FuncETW_Hooked(int* a, int* b, int* c, int* d, int* e)
        {
            try
            {
                ...
                CallCounter++;
                TestProvider.EventWriteAcquireResource(handle, AllocSize: 1, Allocator: "FuncETW");
       ...
       //         Debugger.Break();
                                        ...
                                        UInt32 InCreationDisposition, UInt32 InFlagsAndAttributes, IntPtr InTemplateFile)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    TestProvider.EventWriteAcquireResource((ulong)lret.ToInt64(), 1, "CreateFile");
                }
                finally
                {
                    NativeAPI.LhBarrierEndStackTrace(backup);
                                             ...
                                             UInt32 dwStyle, Int32 x, Int32 y, Int32 nWidth, Int32 nHeight, IntPtr hWndParent, IntPtr hMenu, IntPtr hInstance, IntPtr lpParam)
        {
            ...
            try
            {
                ...
                TestProvider.EventWriteAcquireResource((ulong)lret.ToInt64(), 1, "CreateWindowExW");
            }
            finally
            {
                NativeAPI.LhBarrierEndStackTrace(backup);
